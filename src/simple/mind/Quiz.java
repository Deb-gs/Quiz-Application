...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username){
        ...
        setBounds(30,10,1440,850);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        ImageIcon il = new ImageIcon(ClassLoader.getSystemResource("simple/mind/icons/quiz.jpg"));
        ...
        qno.setBounds(100, 470, 40, 30);
        add(qno);
        
        question = new JLabel("");
        question.setFont(new Font("Tahoma",Font.PLAIN,24));
        question.setBounds(130, 470, 700, 30);
        add(question);
    ...
    public void paint(Graphics g){
        ...
        if(timer > 0) {
            g.drawString(time, 1120, 480);
        }else {
            g.drawString("Times Up!!", 1120, 480);
        }
